...
<body>
    <div class="w-3/4 md:flex md:justify-around md:item-center mx-auto">
        <div class="flex items-center justify-between">
        <img class="mx-auto h-50 w-auto" src="images/logo.png" alt="Your Company">
        </div>
        <div class=" w-full max-w-[550px] bg-white">
            <h2 class="my-10 text-center text-2xl/9 font-bold tracking-tight text-[#350fa0]">Inscription</h2>
            <form method="POST">
                <div class="mb-5 md:flex md:justify-between">
                    <div>
                        ...
                        <input type="text" name="nom" id="nom" placeholder="Entrez votre nom" 
                            ...
                            class="w-full rounded-md border border-[#e0e0e0] bg-white px-4 py-2.5 text-base font-medium text-[#6B7280] outline-none focus:border-[#4415c0] focus:shadow-md" />
                ...
                <div>
                    <button name="enregistrer"
                        class="flex w-full justify-center rounded-md bg-[#4415c0] px-4 py-2.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-[#350fa0] focus-visible:outline-2 focus-visible:outline-offset-2 ">
                        Enregistrer
                    </button>
                </div>
                ...
                <p class="mt-10 text-center text-sm/6 text-gray-500">
                    Vous avez un compte?
                    <a href="login.php" class="font-semibold text-[#e00074]">Connectez-vous</a>
                </p>
