...
<body>
  <div class="flex min-h-full flex-col justify-center px-6 py-8 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-[#350fa0]">Connectez-vous à votre compte</h2>
    </div>
      ...
      <form class="space-y-6" action="#" method="POST">
        ...
        <div>
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm">
              <a href="#" class="font-semibold  text-[#e00074]">Mot de passe oublié ?</a>
            </div>
          </div>
          <div class="mt-2">
            <input type="password" name="password" id="password" autocomplete="current-password"  class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-1 focus:-outline-offset-2 focus:outline-[#4415c0] sm:text-sm/6">
          </div>
          <span class="text-sm/6 text-red-600"><?= isset($erreur['password']) ?  $erreur['password'] : ''?></span>
        </div>

        <div>
          <button type="submit" name="connecter" class="flex w-full justify-center rounded-md px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs bg-[#4415c0] hover:bg-[#350fa0] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#4415c0]">Se connecter</button>
        </div>
      </form>

      <p class="mt-10 text-center text-sm/6 text-gray-500">
        Vous n’avez pas de compte?
        <a href="inscription.php" class="font-semibold  text-[#e00074]">S'inscrire</a>
      </p>
    </div>
  </div>
</body>
